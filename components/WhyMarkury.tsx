...
export default function WhyMarkury() {
  ...
  return (
    <section className="relative overflow-hidden py-20 sm:py-32 bg-markury-lime/5">
      {/* Background accent */}
      <div className="pointer-events-none absolute inset-0 -z-10">
        <div className="absolute -left-24 top-16 w-80 h-80 bg-gradient-to-br from-markury-lime/40 via-markury-cyan/30 to-white rounded-full blur-3xl opacity-80 float-slower" />
      </div>
      ...
      <div className="container-narrow relative">
        ...
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight mb-4 text-gray-900">
            ...
            <span className="marker-underline marker-underline--lime">Markury</span>
          </h2>
        ...
        {/* Comparison Table */}
        <div className="bg-white rounded-3xl border border-markury-lime/30 shadow-sm overflow-hidden mb-16">
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead>
                <tr className="border-b border-gray-100 bg-markury-lime/10">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {highlights.map((highlight, index) => (
            <div key={index} className="text-center sm:text-left">
              <div className="w-14 h-14 bg-markury-lime/20 rounded-2xl flex items-center justify-center text-gray-800 mb-4 mx-auto sm:mx-0">
                {highlight.icon}
              </div>
