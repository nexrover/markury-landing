  ...
  const useCases = [
    {
      ...
      color: "bg-markury-cyan/15 text-markury-cyan",
    },
    {
      ...
      color: "bg-markury-purple/15 text-markury-purple",
    },
    {
      ...
      color: "bg-markury-pink/15 text-markury-pink",
    },
    {
      title: "Remote Teams",
      ...
      color: "bg-markury-lime/15 text-markury-lime",
    },
    {
      ...
      color: "bg-markury-orange/15 text-markury-orange",
    },
    {
      title: "Developers",
  ...
  return (
    <section id="use-cases" className="relative overflow-hidden py-20 sm:py-32">
      ...
      <div className="pointer-events-none absolute -z-10 inset-0">
        <div className="absolute -right-16 top-24 w-72 h-72 bg-gradient-to-br from-markury-orange/40 to-markury-pink/30 rounded-full blur-3xl opacity-25 float-slow" />
      </div>
              ...
              <ul className="space-y-2">
                {useCase.examples.map((example, exIndex) => (
                  <li key={exIndex} className="flex items-center gap-2 text-sm text-gray-500">
                    <CheckmarkCircle02Icon className="w-4 h-4 text-markury-lime flex-shrink-0" />
                    {example}
                  </li>
                ))}
              </ul>
